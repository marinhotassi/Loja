...
mixin _$LojaStore on _LojaStoreBase, Store {
  final _$valueAtom = Atom(name: '_LojaStoreBase.value');
  ...
  final _$_LojaStoreBaseActionController =
      ActionController(name: '_LojaStoreBase');

  @override
  void increment() {
    final _$actionInfo = _$_LojaStoreBaseActionController.startAction(
        name: '_LojaStoreBase.increment');
    try {
