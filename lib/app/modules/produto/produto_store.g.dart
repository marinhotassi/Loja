...
mixin _$ProdutoStore on _ProdutoStoreBase, Store {
  final _$valueAtom = Atom(name: '_ProdutoStoreBase.value');
  ...
  final _$_ProdutoStoreBaseActionController =
      ActionController(name: '_ProdutoStoreBase');

  @override
  void increment() {
    final _$actionInfo = _$_ProdutoStoreBaseActionController.startAction(
        name: '_ProdutoStoreBase.increment');
    try {
